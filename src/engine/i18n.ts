...
const en = {
  ...
  'liveview.trackMirroredNote': 'This telescope mirrors the view left-right — vertical drags feel natural, but sideways feels backwards.',
...
const hi: Record<TranslationKey, string> = {
  ...
  'telemetry.play': 'प्ले',
  'telemetry.recenter': 'पुनः केंद्रित',
  ...
  'liveview.trackMirroredNote': 'यह टेलीस्कोप दृश्य को बाएँ-दाएँ पलट कर दिखाता है — ऊपर-नीचे खींचना सामान्य लगेगा, लेकिन बाएँ-दाएँ उल्टा महसूस होगा।',
